...
(function(){
  ...
  function renderCart(containerId, summaryId){
    ...
    /* coşul are produse — readucem coloana de sumar */
    var layoutFull = tableEl.closest('.cart-layout');
    if (layoutFull) layoutFull.classList.remove('is-empty');
